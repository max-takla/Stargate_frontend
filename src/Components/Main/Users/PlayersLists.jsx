...
export default function PlayersLists() {
    ...
    const fetchUsers = async () => {
      ...
      try {
        ...
        if (result?.data?.Users) {
          const playerUsers = result.data.Users.filter(
...
//   handle with show profile
const handleProfile=(id)=>{
    navigator(`/user-profile/${id}`);
}
  return (
                  ...
                  <TableRow hover key={row.user_id}>
                    ...
                    <TableCell align="center">
                      ...
                      <Button title="user profile"
                        onClick={() => handleProfile(row.user_id)}
                        sx={{ minWidth: "unset", p: isMobile ? 0.5 : 1 }}> <AccountBoxIcon  sx={{
                            color: mainColor,
                            fontSize: isMobile ? 18 : 24,
                          }}/></Button>
                      <Modal
